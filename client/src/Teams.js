...
class Teams extends React.Component {
  ...
  getModal = () => {
    ...
    return <ModalWrapper title='Create team' body={body} onClose={this.hideModal} />
  }

  TeamActionBar = () => {
    return (
      <ActionBar client={this.props.client}>
        <Button variant='primary' size='sm' active onClick={this.showModal}>
          + new team
        </Button>
      </ActionBar>
    )
  ...
  render() {
    ...
    return <div className='Teams'>{body}</div>
  }
}
