    ...
    const expectedDbState = {
      ...
      services: [
        ...
        },
        {
          ...
          ingress: {
            ...
            hasCert: false,
            hasSingleSignOn: false,
            domain: 'hello.team-otomi.dev.gke.otomi.cloud',
            path: undefined,
            subdomain: '',
            useDefaultSubdomain: false,
            forwardPath: false,
      ...
      clusters: [
        ...
        },
        {
          ...
          name: 'martijn',
          dnsZones: ['gke.otomi.cloud'],
          domain: 'martijn.gke.otomi.cloud',
          k8sVersion: 1.17,
          hasKnative: true,
          region: 'europe-west4',
          id: 'google/martijn',
