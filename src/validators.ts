import { str, bool, json, cleanEnv as clean, CleanEnv, StrictCleanOptions, ValidatorSpec } from 'envalid'
...
export const TEAM_NAMES = json({ desc: 'A comma separated list of team names' })
